...
<ul>
	...
	<li>
		...
		<li> page : Object, 일반 자바 객체 (요청처리 웹서블릿 객체가 아닙니다.)</li>
	...
	<%
	   	//현재 요청 처리하는 jsp 페이지의 Exception 객체를  paageContext.getException() 리턴받는다.
	   	// --> Exception 발생시  --> 
	   	//오류 없으면 Exception 객체는 null입니다.
		//String messge = pageContext.getException().getMessage();
	    //out.print(messge);
